...
export function exportExceljs(tableList, date, fileName, gxtableList) {
  ...
  const labelText = `江苏${month}.${day}到货明细`; // 如果没有选择日期，显示默认文本 
  ...
  // 将工作表添加到工作簿中  
  XLSX.utils.book_append_sheet(wb, ws, '江苏物流汇总表');
...
function setExcelStyletwo(data) {
  ...
  data['!cols'] = [
    ...
    { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, { wpx: 50.28 }, calculateColumnWidth(data, 'w'), { wpx: 100 } // 最后一列宽度为0（隐藏列）
  ];
...
function setExcelStyle(data) {
  ...
  data['!cols'] = [
    ...
    { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 }, { wpx: 54 },{ wpx: 54 }, calculateColumnWidth(data, 'x') // 最后一列宽度为0（隐藏列）
  ];
