 ...
 */
export function exportExcelgx(tableList, date, fileName) {
  ...
  const labelText = `广西${month}.${day}报单-${month}.${day + 1}提货明细`; // 如果没有选择日期，显示默认文本 
  ...
  tableList.forEach(item => {
    ...
    item.box1520100017 || '', item.box1520100016 || '', item.sum || '', item.address || ''
    ])
  })
