    ...
    data() {
        return {
            ...
            dataList: [{
                ...
                deliverydate: '',//到货周期
                vouchdate: '',//下单日期
                factoryProductCode: '10500128',
                factoryProductName: '光明噜渴原味酸奶饮品(常温)300g-1*12纸箱(藏文版)',
                productCode: '1520100080',
                piece: '',
                wlSiteName: 'LOOK雨帆自提',
                wlSiteCode: '12117991',
                days: '8',
                ...
                deliverydate: '',//到货周期
                vouchdate: '',//下单日期
                factoryProductCode: '10500103',
                factoryProductName: '光明噜渴原味酸奶饮品(白桃慕斯味)300g-1*12纸箱(成都)',
                productCode: '1520100069',
                piece: '',
                wlSiteName: 'LOOK雨帆自提',
                wlSiteCode: '12117991',
                days: '8',
