<template>
    <div class='gmwlzdLine'>
        ...
        <el-table border ref="table" v-loading="dataListLoading" :data="currentData" style="width: 100%;">
            <el-table-column :show-overflow-tooltip="true" align="center" width="150" prop="areaName" label="区域" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="linename" label="线路" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="sitecode" label="光明站点编号" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="sitename" label="光明站点名称" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="type" label="单/双号" />
...
import AddOrUpdate from './gmwlzdLine-add-updata'
export default {
    components: {
        AddOrUpdate,
    },
    name: 'gmwlzdLine-page',
    data() {
        return {
            msg: 'gmwlzdLine-page',
            dataForm: {
    ...
    methods: {
        ...
        getDataList() {
            ...
            api.wlDeliveryLineAPI(this.dataForm).then(res => {
