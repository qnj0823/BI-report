<template>
    <div class='TwoLogistics'>
        ...
        <el-table ref="table" v-loading="dataListLoading" :data="currentData" style="width: 100%;">
            ...
            <el-table-column :show-overflow-tooltip="true" align="center" prop="wlSiteCode" label="物流站点code" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="wlSiteName" width="180" label="物流站点" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="factoryProductCode" label="NCC产品编号" />
...
import AddOrUpdate from './TwoLogistics-add-updata'
// import {
//     exportExcel
// } from './TwoLogistics.js'
export default {
    name: 'wl-page',
    components: {
        AddOrUpdate,
    ...
    methods: {
        ...
        getDataList() {
            this.dataListLoading = true
            api.wlFacteprocheckTwoApi(this.dataForm).then(res => {
                this.dataList = res
        ...
        deleteHandle(id) {
            ...
            this.$confirm(`您确定对[ids=${ids.join(',')}]进行[${id ? '删除' : '批量删除'}]操作?`, '提示', {
                ...
                console.log('删除', ids);
                api.wlFacteprodelTwoApi(ids).then(res => {
                    // TODO 处理删除
