 ...
 */
export function exportExcelgx(tableList, gxtableList, date, fileName, gxtableList1) {
  ...
  const labelText = `广西${month}.${day}到货明细`; // 如果没有选择日期，显示默认文本 
...
function setExcelStyletwo(data) {
  ...
  // 2. 初始化列宽设置
  data['!cols'] = [
    calculateColumnWidth(data,'A'), { wpx: 120 }, calculateColumnWidth(data,'C'), { wpx: 90 },
...
function setExcelStyle(data) {
  ...
  // 2. 初始化列宽设置
  data['!cols'] = [
    { wpx: 100 },calculateColumnWidth(data,'B'), { wpx: 100 }, calculateColumnWidth(data,'D'),
    { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 },
    { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 80 }, { wpx: 100 }, { wpx: 100 },{ wpx: 100 },{ wpx: 100 },{ wpx: 100 }, { wpx: 100 }, calculateColumnWidth(data,'w') // 最后一列宽度为0（隐藏列）
  ];
