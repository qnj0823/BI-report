<template>
    ...
    <el-dialog :title="!dataForm.id ? '新增-ADD' : '修改-EDITE'" :close-on-click-modal="false" :visible.sync="visible">
        ...
        <el-form :model="dataForm" ref="dataForm" @keyup.enter.native="dataSubmit()" label-width="160px">                  
                    ...
                    <el-form-item label="单双号" prop="type">
                        <el-input v-model="dataForm.type" style="width: 100%;"  placeholder="单号填'1'/双号填'2'">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="线路" prop="linename">
                        <el-input v-model="dataForm.linename" style="width: 100%;"  placeholder="线路">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="光明站点编号" prop="sitecode">
                        <el-input v-model="dataForm.sitecode" style="width: 100%;"  placeholder="光明站点编号">
                        </el-input>
                    </el-form-item>
                    <el-form-item label="光明站点名称" prop="sitename">
                        <el-input v-model="dataForm.sitename" style="width: 100%;"  placeholder="光明站点名称">
                        </el-input>
                    </el-form-item>
