...
export function exportExcel(tableList, fileName) {
  let tableData = [
    ['战区', '今日数据', '今日数据', '今日数据', '今日数据', '今日数据', '今日数据', '累计数据', '累计数据', 
      '累计数据', '累计数据', '累计数据', '累计数据']
  ]
  const tableTop = [ '战区', '低温系列', '常温系列', '果汁系列', '椰子牛乳系列', '椰子汁系列', '今日报单', '低温系列',
    '常温系列','果汁系列', '椰子牛乳系列', '椰子汁系列','累计报单'
  ]
  tableData.push(tableTop)
  tableList.forEach(item => {
    tableData.push([item.orgname || '', item.lowSeriesday || '', item.NorSeriesday || '', item.FruitSeriesday || '', item.YzSeriesday || '', item
