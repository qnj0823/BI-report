...
export function exportExcel(tableList, fileName) {
  let tableData = [
    ['销售区域/省区','分公司/办事处', '老品', '老品', '老品', '老品', '老品', '老品', '老品', '老品', 
  ...
  const tableTop = [ '销售区域/省区','分公司/办事处', '大原味', '小原味', '优选原味', '小原味（戴永红定制）', '小原味（绿叶定制）', '大白桃', '小白桃',
  ...
  tableList.forEach(item => {
    tableData.push([item.sqname || 0,item.ocustomerClass_name || 0, item.bigyuanwei || 0, item.smallyuanwei || 0, item.yxyuanwei || 0, item.xyuanweidyh || 0, item
