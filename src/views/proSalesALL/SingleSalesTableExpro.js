...
export function exportExcel(tableList, fileName) {
  ...
  const tableTop = [ '战区', '大原味', '小原味', '优选原味', '小原味（戴永红定制）', '小原味（绿叶定制）', '大白桃', '小白桃',
    '大清新','小清新','450清新', '大健爽', '小健爽','大0糖','小0糖','蓝色健爽','健能','姜黄','330','310','180酸乳酪(白）','180酸乳酪(红）','180活力健爽','455活力健爽','200鲜酪乳','450鲜酪乳','1L椰子牛乳','1L椰子牛乳(定制款）','950常温(常规版）','950常温(宴席版）',
  ...
  tableList.forEach(item => {
    tableData.push([item.nAME || '', item.bigyuanwei || '', item.smallyuanwei || '', item.yxyuanwei || '', item.xyuanweidyh || '', item
      .xyuanweily || '', item.dbt || '', item.xbt || '', item.dqx || '', item.xqx || '',item.qinxi450 || '', item.djs || '',
      item.xjs || '', item.dlt || '',item.xlt || '',item.lsjs || '',item.jn || '',item.jh || '',item.yz330|| '',item.yz310|| '',item.snnb180|| '',item.snnred180|| '',item.js180|| 0,item.js455|| 0,item.ylr200|| 0,item.ylr450|| 0,item.lyznr1|| '',item.lyznrdz1|| '',
      item.cgb970|| '',item.yxb970|| '',item.yxb300|| '',item.jdb300|| '',item.cz380|| '',item.cz135|| '',item.syz380|| '',item.syz135|| '',item.yzs1l|| '',item.yzs380|| '',item.yzz245|| '',item.lyzz1|| '',item.yzz300|| '',item.hpyzz125|| '',item.lpyzz125|| '',item.lkyzz300|| '',
