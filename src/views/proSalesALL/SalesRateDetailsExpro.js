...
export function exportExcel(tableList, fileName) {
  let tableData = [
    ['销售区域/省区', '分子公司','站点',  '今日数据', '今日数据', '今日数据', '今日数据', '今日数据', '今日数据', '累计数据', '累计数据', 
      '累计数据', '累计数据', '累计数据', '累计数据']
  ]
  const tableTop = [ '销售区域/省区','分子公司', '站点',  '低温系列', '常温系列', '果汁系列', '椰子牛乳系列', '椰子汁系列', '今日报单', '低温系列',
    '常温系列','果汁系列', '椰子牛乳系列', '椰子汁系列','累计报单'
  ]
  tableData.push(tableTop)
  tableList.forEach(item => {
    tableData.push([item.sqname || '',item.ocustomerclassName || '',item.cSiteName || '', item.lowSeriesday || '', item.NorSeriesday || '', item.FruitSeriesday || '', item.YzSeriesday || '', item
      .YzzSeriesday || '', item.sumday || '', item.lowSeries || '', item.NorSeries || '', item.FruitSeries || '', item.YzSeries || '',
      item.YzzSeries || '', item.sum || ''])
  })
