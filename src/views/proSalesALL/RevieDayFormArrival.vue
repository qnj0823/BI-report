<template>
    <div class='RF'>
        ...
        <el-table class="table" ref="table" border :data="currentData" v-loading="dataListLoading"
            ...
            <el-table-column fixed :show-overflow-tooltip="true" width="140" align="center" prop="nAME" label="战区" />
            ...
            <el-table-column fixed :show-overflow-tooltip="true" align="center" width="150" prop="vouchdate"
                label="报单日期" />
                <el-table-column fixed :show-overflow-tooltip="true" align="center" width="150" prop="arrivaldate"
                label="到货日期" />
    ...
    methods: {
        ...
        async getDataList() {
            ...
            for (const date of dateArray) {
                ...
                // 调用 API  
                const res = await api.checkNccArrivalApi(dictForm);
