...
export function exportExcel(tableList, date, fileName) {
  ...
  const labelText = `${year}年${month}月各战区常温报单进度表--截止${month}月${day}日`; // 如果没有选择日期，显示默认文本 
...
function setExcelStyle(data) {
  ...
  data['!cols'] = [
    ...
    { wpx: 90 }, { wpx: 90 }, { wpx: 90 }, { wpx: 110 }, { wpx: 100 }, { wpx: 75 }, { wpx: 100 } // 最后一列宽度为0（隐藏列）
  ];
