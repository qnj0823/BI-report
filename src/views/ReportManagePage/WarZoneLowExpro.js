...
export function exportExcel(tableList, date, fileName) {
  ...
  const labelText = `${year}年${month}月各战区低温报单进度表--截止${month}月${day}日`; // 如果没有选择日期，显示默认文本 
...
function setExcelStyle(data) {
  ...
  // 2. 初始化列宽设置
  data['!cols'] = [
    { wpx: 90 }, { wpx: 80 }, { wpx: 80 }, { wpx: 110 },
    { wpx: 90 }, { wpx: 90 }, { wpx: 90 }, { wpx: 90 },
    { wpx: 120 }, { wpx: 90 }, { wpx: 90 }, { wpx: 100 }, { wpx: 90 }, { wpx: 90 } // 最后一列宽度为0（隐藏列）
  ];
