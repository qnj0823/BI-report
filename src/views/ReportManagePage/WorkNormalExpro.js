...
export function exportExcel(tableList, date, fileName) {
  ...
  const labelText = `${year}年${month}月各班组常温报单进度表--截止${month}月${day}日`; // 如果没有选择日期，显示默认文本 
  ...
  const tableTitle = ['序号', '班组', '负责人', '今日报单(常温系列)', `${month}月目标\n(椰子汁系列)`, `${month}月目标(其它常温)`, `${month}月目标(常温全品)`, `${month}月累计-常温系列(标准件)`, `${month}月累计-常温系列(标准件)`,
    `${month}月累计-常温系列(标准件)`, `${month}月累计-常温系列(标准件)`, `${month}月累计-常温系列(标准件)`, `${month}月累计-常温系列(标准件)`, `${month}月差额(常温全品)`, `${month}月差额\n(光明椰子汁)`]
  const tablebop = ['序号', '班组',  '负责人', '今日报单(常温系列)', `${month}月目标\n(椰子汁系列)`, `${month}月目标(其它常温)`,`${month}月目标(常温全品)`, `300常温`, `950常温`,
    `果汁系列`, `1L椰乳`, `椰子汁系列截止今日累计完成`, `常温系列截止今日累计完成`, `${month}月差额(常温全品)`, `${month}月差额\n(光明椰子汁)`]

  tableData.push(tableTitle)
  tableData.push(tablebop)
  tableList.forEach(item => {
    tableData.push([item.sort || '', item.teamsno || '', item.teamsperson || '', item.box || '', item
