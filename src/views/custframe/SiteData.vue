<template>
    <div class='SiteData'>
        ...
        <el-table ref="table" v-loading="dataListLoading" :data="currentData" style="width: 100%;">
            ...
            <el-table-column :show-overflow-tooltip="true" align="center" prop="companyname" label="省区" />
            <el-table-column prop="" align="center" label="省区负责人" />
            <el-table-column prop="" align="center" label="单位体" />
            <el-table-column prop="" align="center" label="单位体负责人" />
            <el-table-column prop="" align="center" label="客户站点" />
            <el-table-column prop="" align="center" label="单双号" />
            <el-table-column prop="" align="center" label="目标增幅" />
...
// import AddOrUpdate from './Lowdata-add-updata'
// import {
//     exportExcel
// } from './LowdataExpro.js'
export default {
    components: {
        // AddOrUpdate,
    },
    ...
    methods: {
        exportData() {
            this.$confirm('是否导出表格数据到Excel?', '提示', {
                ...
                exportExcel(this.dataList.content, '低温增幅比数据.xlsx')
            })
        },
        //选择文件
        openFileInput() {
        ...
        uploadFile() {
            ...
            if (this.dataForm2.file) {
                ...
                api.APILowTempIMPORT(formData).then(res => {
                    this.getDataList()
        ...
        getDataList() {
            api.APILowTempCHECK(this.dataForm).then(res => {
                this.dataList = res
                // 过滤数据  
