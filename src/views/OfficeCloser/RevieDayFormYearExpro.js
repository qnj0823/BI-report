...
export async function exportExcel(tableList, fileName) {
  ...
  const subHeaders = ['战区', '省区', '分公司\n办事处', '客户营业执照', '站点', '报单日期', '大原味', '小原味', '优选原味', '小原味\n(戴永红定制)', '小原味\n(绿叶定制)', '大白桃', '小白桃',
    ...
    '300常温\n(宴席版）', '300常温\n(经典版）', '380橙汁', '1.35橙汁', '380双柚汁', '1.35双柚汁', '300小青柠汁', '900小青柠汁', '300苹果汁', '900苹果汁', '300芒果菠萝汁', '900芒果菠萝汁', '1L椰子牛乳', 
  ...
  tableList.forEach(item => {
    worksheet.addRow([
      ...
      item.box1520100027 || '', item.box1520100028 || '', item.box1520100030 || '', item.box1520100029 || '', item.box1520100032 || '', item.box1520100031 || '', item.box1520100040 || '', item.box1520100039 || '', item.box1520100038 || '', item.box1520100037 || '',
