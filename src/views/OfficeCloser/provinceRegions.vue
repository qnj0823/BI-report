<template>
    <div class='SalesProgressSummary'>
        ...
        <el-table border ref="table" v-loading="dataListLoading" height="680" :data="dataList" style="width: 100%;">
            ...
            <el-table-column width="110" align="center" label="负责人" prop="sqman" />
    ...
    methods: {
        async getdataList() {
            ...
            try {
                ...
                this.bscList = this.filterEmptyLevelName2(this.fgsList);
