<template>
    <div class='SalesProgressSummarySite'>
...
import {
    exportExcel
} from './SalesProgressSummarySiteExpro.js'
import * as api from '@/api/frame/customer.js'
export default {
    name: 'SalesProgressSummarySite-page',
    data() {
        return {
            msg: 'SalesProgressSummarySite-page',
            dataForm: {
                p_vouchdatestart: '',
                p_vouchdateend: ''
            },
    ...
    methods: {
        ...
        async getdataList() {
            ...
            console.log(this.dataFormADD, this.dataFormNow, this.yearForm)
            try {
                const [yearCAR, yearADD, nowCAR, nowADD, ljtqjr, goal] = await Promise.all([
                    api.companypartSite(this.yearForm),//累计基数-当前日期
                    api.companypartSite(this.dataFormADD),//本月累计基数
                ...
                //第五个接口 按框架走的里面的数据(废弃),用该接口获取省区，单位体，类型等值
