<template>
    <div class='lowdata'>
        ...
        <el-table ref="table" v-loading="dataListLoading" :data="currentData" style="width: 100%;">
            <el-table-column :show-overflow-tooltip="true" align="center" prop="sqname" label="战区" />
            ...
            <el-table-column :show-overflow-tooltip="true" align="center" prop="yearmonthdate" label="日期" />
            <el-table-column :show-overflow-tooltip="true" align="center" prop="goalvalue" label="去年低温基数" />
    ...
    methods: {
        ...
        uploadFile() {
            ...
            if (this.dataForm2.file) {
                ...
                api.APILowTempBasePORT(formData).then(res => {
                    this.getDataList()
        ...
        getDataList() {
            api.APILowTempLBaseCHECK(this.dataForm).then(res => {
                this.dataList = res
                // 过滤数据  
