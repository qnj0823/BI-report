    ...
    <div class='dqsales'>
        <div>
            ...
            <el-table class="table" ref="table" border :data="currentData" v-loading="dataListLoading"
                ...
                <el-table-column fixed :show-overflow-tooltip="true" align="center" width="140" prop="cSiteName"
                    label="站点" />
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            ...
            oapi.productonesellsitebip(this.dataForm).then(res => {
                this.dataList = res;
                ...
                console.log(this.dataList,1565)
