...
export function exportExcel(tableList, fileName) {
  ...
  tableList.forEach(item => {
    tableData.push([ item.sqname || '', item.ocustomerclassName || '',item.cSiteName || '', item.lowSeries || '', item.NorSeries || '', item.FruitSeries || '',item.YzSeries || '',item.YzzSeries || '',item.QtSeries || '',item.sum || ''
    ])
  })
