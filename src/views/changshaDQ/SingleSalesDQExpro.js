...
export function exportExcel(tableList, fileName) {
  let tableData = [
    ['销售区域/省区','分公司/办事处', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', 
  ...
  const tableTop = [ '销售区域/省区','分公司/办事处', '大原味', '小原味', '优选原味', '小原味（戴永红定制）', '小原味（绿叶定制）','180酸乳酪(白）', '180酸乳酪(红）','大白桃', '小白桃',
  ...
  tableList.forEach(item => {
    tableData.push([item.sqname || '',item.companyname || '', item.bigyuanwei || '', item.smallyuanwei || '', item.yxyuanwei || '', item.xyuanweidyh || '', item
