...
export function exportExcel(tableList, fileName) {
  let tableData = [
    ['销售区域/省区','分公司/办事处', '站点', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', 
      '低温系列', '低温系列', '低温系列', '低温系列','低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列', '低温系列','低温系列','低温系列','椰子牛乳系列','椰子牛乳系列','常温系列','常温系列','常温系列','常温系列','果汁系列','果汁系列','果汁系列','果汁系列','果汁系列','果汁系列','果汁系列','果汁系列','果汁系列','果汁系列','椰子汁系列','椰子汁系列','椰子汁系列','椰子汁系列','椰子汁系列','其它','小计'
    ]
  ]
  const tableTop = [ '销售区域/省区','分公司/办事处','站点',  '大原味', '小原味', '优选原味', '小原味（戴永红定制）', '小原味（绿叶定制）','180酸乳酪(白）', '180酸乳酪(红）','大白桃', '小白桃',
    '大清新','小清新','450清新', '大健爽', '小健爽','大0糖','小0糖','蓝色健爽','健能','姜黄','330','310','1L椰子牛乳','1L椰子牛乳(定制款）','970常温(常规版）','970常温(宴席版）',
    '300常温(宴席版）','300常温(经典版）','380橙汁','1.35橙汁','380双柚汁','1.35双柚汁','300小青柠汁','900小青柠汁','300苹果汁','900苹果汁','300芒果菠萝汁','900芒果菠萝汁','245椰子汁','1L椰子汁','300椰子汁','1.25L红瓶椰子汁','300礼盒椰子汁','其它','小计'
  ]
  tableData.push(tableTop)
  tableList.forEach(item => {
    tableData.push([item.sqname || '',item.ocustomerClass_name || '',item.cSiteName || '', item.bigyuanwei || '', item.smallyuanwei || '', item.yxyuanwei || '', item.xyuanweidyh || '', item
      .xyuanweily || '',item.snnb180|| '',item.snnred180|| '', item.dbt || '', item.xbt || '', item.dqx || '', item.xqx || '',item.qinxi450 || '', item.djs || '',
      item.xjs || '', item.dlt || '',item.xlt || '',item.lsjs || '',item.jn || '',item.jh || '',item.yz330|| '',item.yz310|| '',item.lyznr1|| '',item.lyznrdz1|| '',
      item.cgb970|| '',item.yxb970|| '',item.yxb300|| '',item.jdb300|| '',item.cz380|| '',item.cz135|| '',item.syz380|| '',item.syz135|| '',item.xqn300|| '',item.xqn900|| '',item.pgz300|| '',item.pgz900|| '',item.mgbl300|| '',item.mgbl900|| '',item.yzz245|| '',item.lyzz1|| '',item.yzz300|| '',item.hpyzz125|| '',item.lkyzz300|| '',item.Qtnmer|| '',item.max|| ''
    ])
  })
