    ...
    <div class='dqsales'>
        ...
        <el-form :inline="true" style="width: 100%; margin: 0 auto;">
            ...
            <el-form-item>
                ...
                <el-button size="mini" class="filter-item" @click="getDataList" type="success">单品</el-button>
                <el-button size="mini" class="filter-item" @click="getoldDataList" type="success">老/新品</el-button>
                <el-button size="mini" class="filter-item" @click="getproDataList" type="success">产品系列</el-button>
            </el-form-item>
        </el-form>

        <div v-if="oldnewshow">
            <oldnewUpdate ref="oldnewupdata" :start-time="startTime" :end-time="endTime" :message="message">
            </oldnewUpdate>
        </div>
        <div v-else-if="proshow">
            <proSerisUpdate ref="proupdata" :start-time1="startTime1" :end-time1="endTime1" :message1="message1"
                :message2="message2">
            </proSerisUpdate>
        </div>
        <div v-else>
            ...
            <el-table class="table" ref="table" border :data="currentData" v-loading="dataListLoading"
                ...
                <el-table-column fixed :show-overflow-tooltip="true" align="center" width="150" prop="companyname"
                    label="分公司/办事处" />
                ...
                <el-table-column :show-overflow-tooltip="true" align="center" prop="lowSeries" label="果汁系列">
                    ...
                    <el-table-column :show-overflow-tooltip="true" align="center" width="120" prop="syz135"
                        label="1.35双柚汁" />
...
import oldnewUpdate from './oldnewfgs'
import proSerisUpdate from './productSeris'
import {
    exportExcel
...
export default {
    ...
    methods: {
        Enterdetails() {
            this.$router.push({
                path: '/changshaDQ/SingleSalesDQfgs',
                query: {
                    param1: this.rujobs,
        ...
        getoldDataList() {
            this.proshow = false
            this.oldnewshow = true
            this.startTime = this.dataForm.p_vouchdatestart,
                this.endTime = this.dataForm.p_vouchdateend,
                this.message = this.rujobs
            setTimeout(() => {
                // 一秒后执行的操作 
                this.$refs.oldnewupdata.getdataList();
            }, 100);
        },
        getproDataList() {
            this.proshow = true
            this.oldnewshow = false
            this.startTime1 = this.dataForm.p_vouchdatestart,
                this.endTime1 = this.dataForm.p_vouchdateend,
                this.message1 = this.rudepts
            this.message2 = this.rujobs
            setTimeout(() => {
                // 一秒后执行的操作 
                this.$refs.proupdata.getDataList();
            }, 100);
        },
        //单品销量
        sqsinglefn() {
            this.dataForm1.p_orgname = this.rujobs,
                this.dataForm1.p_vouchdatestart = this.dataForm.p_vouchdatestart,
                this.dataForm1.p_vouchdateend = this.dataForm.p_vouchdateend,
                api.indexsqnccApi(this.dataForm1).then(res => {
                    const sqsingle = res;
                    ...
                    updatedData.sort((a, b) => b.box - a.box);
        ...
        getDataList() {
            ...
            oapi.productonesellcompany(this.dataForm).then(res => {
                this.dataList = res
