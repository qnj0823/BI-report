...
export function exportExcel(tableList, fileName) {
  let tableData = [
    ['分公司/办事处', '老品', '老品', '老品', '老品', '老品', '老品', '老品', '老品', 
      '老品', '老品', '老品', '老品', '老品', '老品', '老品', '老品', '老品', '老品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','新品','小计'
    ]
  ]
  const tableTop = [ '分公司/办事处', '大原味', '小原味', '优选原味', '小原味（戴永红定制）', '小原味（绿叶定制）', '大白桃', '小白桃',
    '大清新','小清新', '大健爽', '小健爽','大0糖','小0糖','蓝色健爽','健能','姜黄','330','310','180酸乳酪(白）','180酸乳酪(红）','1L椰子牛乳','1L椰子牛乳(定制款）','970常温(常规版）','970常温(宴席版）',
    '300常温(宴席版）','300常温(经典版）','380橙汁','1.35橙汁','380双柚汁','1.35双柚汁','245椰子汁','1L椰子汁','300椰子汁','1.25L红瓶椰子汁','300礼盒椰子汁','小计'
  ]
  tableData.push(tableTop)
  tableList.forEach(item => {
    tableData.push([item.companyname || '', item.bigyuanwei || '', item.smallyuanwei || '', item.yxyuanwei || '', item.xyuanweidyh || '', item
      .xyuanweily || '', item.dbt || '', item.xbt || '', item.dqx || '', item.xqx || '', item.djs || '',
      ...
      item.cgb970|| '',item.yxb970|| '',item.yxb300|| '',item.jdb300|| '',item.cz380|| '',item.cz135|| '',item.syz380|| '',item.syz135|| '',item.yzz245|| '',item.lyzz1|| '',item.yzz300|| '',item.hpyzz125|| '',item.lkyzz300|| '',item.max|| ''
    ])
  })
